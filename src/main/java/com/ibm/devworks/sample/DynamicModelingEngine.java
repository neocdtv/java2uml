...
public class DynamicModelingEngine {
	...
	public void createSubDynamicEPackage() {
		// Instantiate EPackage and provide unique URI to identify the package
		// instance
		EPackage subPackage = _coreFactory.createEPackage();
		subPackage.setName("SubPackage");
		subPackage.setNsPrefix("sub");
		subPackage
				.setNsURI("http:///com.ibm.dynamic.example.bookStore.sub.ecore");
		_bookStoreEPackage.getESubpackages().add(subPackage);
	}
	...
	public static void main(String[] args) {
		...
		theModelSerializer
				.serializeMetaModel(Arrays.asList(theModelingEngine._bookStoreEPackage), "bookstore");
		theModelSerializer.serializeModelInstance(
				theModelingEngine._bookStoreEObject, isSchemaLocationPresent);
