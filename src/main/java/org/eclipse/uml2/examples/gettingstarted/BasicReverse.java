...
public class BasicReverse {
  ...
  private static void serialize(Model nature, Collection<EPackage> ePackages) {
    ModelSerializer.serializeEcore(ePackages,
        "/home/xix/Projects/workspace-eclipse-modeling-current/reversed-models/model/ReversedModels.ecore");
    ModelSerializer.serializeEcoreJson(ePackages,
        "/home/xix/Projects/workspace-eclipse-modeling-current/reversed-models/model/ReversedModels.json");
    ModelSerializer.serializeUml(nature,
        "/home/xix/Projects/workspace-eclipse-modeling-current/reversed-models/model/ReversedModels.uml");
  }
